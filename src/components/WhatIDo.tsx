        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Languages & Web</h4>
              <p>
                Proficient in modern programming languages and frontend technologies
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Backend & Tools</h4>
              <p>
                Experienced in server-side development, database management, and
                using industry-standard tools for development.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Linux Administration</div>
